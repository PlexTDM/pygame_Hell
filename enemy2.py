...
class Skull_Red(AnimatedSprite):
    def __init__(self, screen, pos, player, enemyGroup, minutes):
        ...
        self.speed = 130 + minutes * 10
        self.lastHit = 0
        self.color_change_duration = 300
        self.color_changed_time = 0
        self.health = 20 + minutes
        self.dmg = 20
        self.xp = 3
    ...
    def loadImg(self):
        spritesheet = SpriteSheet('./assets/Monsters/Skull/SpriteSheet.png')
        scale = 3    
